...
{
  response_builder_t init_response(response_builder_t response, string content_type = "plain/text");
  ...
  {
    string response_json = json_dto::to_json(data);
  ...
  restinio::request_handling_status_t return_internal_server_error(response_builder_t &response, const exception &exception);
